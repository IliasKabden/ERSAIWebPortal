...
{
    [Authorize]
    public partial class AccountController : AppBaseMVCController
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult Login(string returnUrl, LoginPageMessage message)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new AppUser { UserName = model.Email, Email = model.Email, Id = ERSAIDB.PersonalAccountUsers.First().Badge };
